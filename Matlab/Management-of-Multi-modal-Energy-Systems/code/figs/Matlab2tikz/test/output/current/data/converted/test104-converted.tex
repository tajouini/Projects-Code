...
\addplot [forget plot] graphics [xmin= 0.5, xmax= 3.5, ymin= 3.5, ymax= 6.5] {test104-converted-1.png};
\end{axis}

\begin{axis}[%
width=\figureWidth,
height=0.412\figureHeight,
at={(0\figureWidth,0.55\figureHeight)},
scale only axis,
point meta min=   0,
point meta max=   1,
axis on top,
...
colorbar left,
colorbar style={anchor=south west, at={(-0.125,-1.333)}, height=2.333*\pgfkeysvalueof{/pgfplots/parent axis height}, ylabel={AxisLocation = out}}
]
\addplot [forget plot] graphics [xmin= 0.5, xmax= 3.5, ymin= 3.5, ymax= 6.5] {test104-converted-2.png};
\end{axis}
\end{tikzpicture}%
\end{document}