...
\addplot [forget plot] graphics [xmin= 0.5, xmax= 3.5, ymin= 3.5, ymax= 6.5] {test102-converted-1.png};
\end{axis}
...
colorbar right,
colorbar style={anchor=south west, at={(1.062,-1.333)}, height=2.333*\pgfkeysvalueof{/pgfplots/parent axis height}, ylabel={AxisLocation = out}}
]
\addplot [forget plot] graphics [xmin= 0.5, xmax= 3.5, ymin= 3.5, ymax= 6.5] {test102-converted-2.png};
\end{axis}
\end{tikzpicture}%
\end{document}