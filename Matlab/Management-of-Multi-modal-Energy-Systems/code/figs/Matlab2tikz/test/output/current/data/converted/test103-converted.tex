...
\addplot [forget plot] graphics [xmin= 0.5, xmax= 3.5, ymin= 3.5, ymax= 6.5] {test103-converted-1.png};
\end{axis}
...
colorbar left,
colorbar style={anchor=south west, at={(1.188,-1.333)}, height=2.333*\pgfkeysvalueof{/pgfplots/parent axis height}, ylabel={AxisLocation = in}}
]
\addplot [forget plot] graphics [xmin= 0.5, xmax= 3.5, ymin= 3.5, ymax= 6.5] {test103-converted-2.png};
\end{axis}
\end{tikzpicture}%
\end{document}