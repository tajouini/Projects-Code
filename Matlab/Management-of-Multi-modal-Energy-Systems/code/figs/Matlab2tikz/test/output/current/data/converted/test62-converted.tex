...
\begin{axis}[%
width=0.867\figureWidth,
height=\figureHeight,
at={(0\figureWidth,0\figureHeight)},
scale only axis,
point meta min=-156.536,
point meta max=-21.4901,
axis on top,
separate axis lines,
...
\addplot [forget plot] graphics [xmin=-3.90625, xmax=503.906, ymin=  60, ymax= 340] {test62-converted-1.png};
\end{axis}
\end{tikzpicture}%
\end{document}