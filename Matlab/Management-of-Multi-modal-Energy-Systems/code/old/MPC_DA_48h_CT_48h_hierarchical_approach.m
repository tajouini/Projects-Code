...
%% Upper level MPC: Day ahead
 ...
 %% Setup figures
    ...
    set(findall(gcf,'-property','FontSize'),'FontSize',20)
    set(gcf, 'Position',  [200, -90, 1000, 800])
    sgtitle(f1,'48h-48h Day ahead simulations');
    sgtitle(f2,'48h-48h Closed-loop simulations');
    ...
    load ('C:\Users\Jouini\Documents\Research\IFES-Multi-modale-Energy-systeme\multi-energy-mangement-mpc\data\8760h-01p\PL_CT_N192.mat');
    ...
    load('C:\Users\Jouini\Documents\Research\IFES-Multi-modale-Energy-systeme\multi-energy-mangement-mpc\data\8760h-01p\PV_CT_N192.mat');
    ...
    load('C:\Users\Jouini\Documents\Research\IFES-Multi-modale-Energy-systeme\multi-energy-mangement-mpc\data\8760h-01p\WT_CT_N192.mat');
    ...
    load('C:\Users\Jouini\Documents\Research\IFES-Multi-modale-Energy-systeme\multi-energy-mangement-mpc\data\8760h-01p\HL_CT_N192.mat');
    ...
    load('C:\Users\Jouini\Documents\Research\IFES-Multi-modale-Energy-systeme\multi-energy-mangement-mpc\data\8760h-01p\v_CT_N192.mat');
    % Real purchasing price
...
for ii = simStart:simEnd   % in every 1/4 hour
   ...
   if ii == rr % every 24h iterations, the upper level is triggered
    ...
    energy_DA = energy_DA + sum(sol_DA{13}(1:24))*Delta_DA;
    ...
    for jj = 1:size(Pg_DA,2)
       ...
       Pg_DA_rshp = [Pg_DA_rshp Pg_DA_rshp];%Pg_DA(:,end)*ones(1,Delta_DA*48/Delta_CT)];
     ...
     %% step 2: Continuous trading
        ...
        energy_CT = energy_CT + sol_CT{13}(1)*Delta_CT;
