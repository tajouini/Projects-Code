...
for ii = simStart:simEnd
   ...
   if ii == rr % every 24h iterations, the upper level is triggered
    ...
    index_DA = index_DA + setup_cost_DA(v_GAS_DA,v_DA_real(times_DA), ...
        u_DA_real(times_DA),P_DA_var,H_DA_var, N24, Delta_DA);
    index_mon_DA = index_mon_DA + ...
    monetary_index_DA(v_GAS_DA,v_DA_real(times_DA),u_DA_real(times_DA), ...
